...
if s:t_Co >= 256
  if &background ==# 'dark'
    if s:termtrans
      ...
      hi LineNr ctermfg=243 ctermbg=234 cterm=NONE
      hi Terminal ctermfg=fg ctermbg=235 cterm=NONE
    endif
    if get(g:, 'solarized_visibility', '') ==# 'high'
      hi CursorLineNr ctermfg=166 ctermbg=234 cterm=bold
    ...
    elseif get(g:, 'solarized_statusline', '') ==# 'flat'
      ...
      hi StatusLine ctermfg=235 ctermbg=253 cterm=reverse
      hi StatusLineNC ctermfg=234 ctermbg=252 cterm=reverse
      hi TabLine ctermfg=238 ctermbg=250 cterm=reverse
      hi TabLineFill ctermfg=239 ctermbg=236 cterm=reverse
      hi TabLineSel ctermfg=234 ctermbg=250 cterm=reverse
      hi VertSplit ctermfg=236 ctermbg=243 cterm=NONE
    endif
